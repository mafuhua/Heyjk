 ...
 */
public class WeightWeekPager extends BasePager {
    ...
    public WeightWeekPager(Context context) {
        super(context);
    ...
    public View initView() {
        ...
        Log.d("WeightWeekPager", "mWeek:***************" + mWeek);
        dateList = new ArrayList<>();
        timeList = new ArrayList<>();
        for (int i = 0; i < 30; i++) {
            String date = mYear + "年" + mMonth + "月" + i + "日";
            dateList.add(date);
        }
        for (int i = 0; i < 12; i++) {
...
/*===========组元素表示可折叠的列表项，子元素表示列表项展开后看到的多个子元素项=============*/
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(context, R.layout.elv_weight_week_parent, null);
                viewHolder.textView = (TextView) convertView.findViewById(R.id.tv_elv_date);
                viewHolder.textViewchild = (TextView) convertView.findViewById(R.id.tv_elv_week);
                convertView.setTag(viewHolder);
            } else {
                viewHolder = (ViewHolder) convertView.getTag();
            }
            viewHolder.textView.setText(getGroup(groupPosition).toString());
            viewHolder.textViewchild.setText("第"+mWeek+"周");
            return convertView;
        }
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            if (convertView == null) {
                viewHolder = new ViewHolder();
                convertView = View.inflate(context, R.layout.elv_weight_week_child, null);
                viewHolder.textView = (TextView) convertView.findViewById(R.id.tv_elv_date);
                viewHolder.textViewchild = (TextView) convertView.findViewById(R.id.tv_elv_week);
                convertView.setTag(viewHolder);
            } else {
            ...
            viewHolder.textViewchild.setText("脂肪率00%脂肪率00%脂肪率00%脂肪率00%脂肪率00%脂肪率00%脂肪率00%");
            return convertView;
        }
